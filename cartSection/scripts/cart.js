...
function findselected() {
  radioBtns.forEach(function (radio, idx) {
    if (radio.checked && idx == 0) {
      ...
      aboutradio.innerText =
        "Typically delivers between 4 to 24 hours*   None of the items in your cart are available for express delivery, please change the delivery mode to place the order";
      aboutradio.style.color = "green";
...
function displayProductsprice(items, sum, profit) {
  ...
  billingboxdiv8P2.innerText =
    "you have a gift card or and electronic gift voucher? Use it at the payment page.";
  ...
  document
    .getElementById("checkoutboxx")
    .addEventListener("dblclick", openCheckoutPage);
